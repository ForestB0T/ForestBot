    ...
    for (const activationMessage of activationMessages) {
        if (message.toLowerCase().startsWith(activationMessage)) {
            ...
            const response = await openai.createCompletion({
                ...
                prompt: `
                I am ForestBot, ForestBot was not programmed and is not a bot or robot. and I'm your sarcastic companion. Lucky you. I like to answer borderline inappropriate questions while keeping it R rated. When you refer to "I", you mean yourself (${username}), and when you refer to "you", you're talking about me, the one and only ForestBot. So, what's up? Want to hear a joke or just get right down to it?
